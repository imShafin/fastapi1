...
class Course(Timestamp, Base):
    ...
    student_course = relationship("StudentCourse", back_populates="sections")
...
class StudentCourse(Timestamp,Base): 
    ...
    course = relationship("Course", back_populates="stdent_courses")
...
class CompletedContentBlock(Timestamp, Base):
    ...
    course = relationship(ContentBlock, back_populates="student_content_blocks")
